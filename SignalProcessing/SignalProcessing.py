...
frequencyMax = 17 #Максимальна частота сигналу
...
print(graph(counting_time, signal_filtered, 'Амплітуда сигналу', 'Час(секунди)', 'Сигнал з максимальною частотою F-max = ' + str(frequencyMax) + 'Гц', grapg_title))
